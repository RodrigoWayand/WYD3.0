...
#include <time.h>
#include <Windows.h>
#include "Basedef.h"   // Adicionado para garantir acesso a g_pItemList

// Macros originais com offsets hardcoded (removidas por segurança):
...
// Correção: utilizar o array global g_pItemList (definido em Basedef.h)
#define GetItemList(itemId)  (&g_pItemList[itemId])
#define GetItemName(itemId)  (g_pItemList[itemId].Name)
#define GetItemPrice(itemId) (g_pItemList[itemId].Price)
