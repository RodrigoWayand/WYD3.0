...
public:
    ...
    {
        if (IsWindowed) Windowed_DisplayMode = value; else Fullscreen_DisplayMode = value;
    }

    // ---------------------------------------------------------------------------
    // Getters / Setters — depth/stencil buffer
    // ---------------------------------------------------------------------------
    ...
    {
        if (IsWindowed) Windowed_DepthStencilBufferFormat = value; else Fullscreen_DepthStencilBufferFormat = value;
    }

    // ---------------------------------------------------------------------------
    // Getters / Setters — multisample
    // ---------------------------------------------------------------------------
    ...
    {
        if (IsWindowed) Windowed_MultisampleType = value; else Fullscreen_MultisampleType = value;
    }
    ...
    {
        if (IsWindowed) Windowed_MultisampleQuality = value; else Fullscreen_MultisampleQuality = value;
    }

    // ---------------------------------------------------------------------------
    // Getters / Setters — vertex processing
    // ---------------------------------------------------------------------------
    ...
    {
        if (IsWindowed) Windowed_VertexProcessingType = value; else Fullscreen_VertexProcessingType = value;
    }

    // ---------------------------------------------------------------------------
    // Getters / Setters — present interval
    // ---------------------------------------------------------------------------
    ...
    {
        if (IsWindowed) Windowed_PresentInterval = value; else Fullscreen_PresentInterval = value;
    }
};
