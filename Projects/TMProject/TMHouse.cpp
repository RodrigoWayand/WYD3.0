...
int TMHouse::Render()
{
    ...
    auto RenderScaled = [&](TMMesh* pMesh, float fX, float fY, float fZ, float fAngle, float fAngle2, float fAngle3, char cMulti, int nTexOffset)
    {
        if (!pMesh)
            return;

        int prevTexActive = g_TexOverride.active;
        int prevTexType = g_TexOverride.type;
        int prevTexIndex = g_TexOverride.index;
        ...
        pMesh->Render(fX, fY, fZ, fAngle, fAngle2, fAngle3, cMulti, nTexOffset);
        ...
        g_TexOverride.active = prevTexActive;
        g_TexOverride.type = prevTexType;
        g_TexOverride.index = prevTexIndex;
    };
    ...
    if (m_cHouseType == 11)
    {
        ...
        if (!pMesh)
            return 0;
        RenderScaled(pMesh, m_vecPosition.x, m_fHeight, m_vecPosition.y, m_fAngle, 0, 0, 0, 0);
    ...
    if (m_bVisible == 1)
    {
        ...
        else if (m_cHouseType == 1)
        {
            ...
            if (!pMesh)
                return 0;
            RenderScaled(pMesh, m_vecPosition.x, m_fHeight + 5.2199998f, m_vecPosition.y, m_fAngle - 1.5707964f, m_fWindMillAngle, 1.5707964f, 0, 0);
        }
        else if (m_cHouseType == 2 || m_cHouseType == 3)
        {
            ...
            if (RenderDevice::m_bDungeon && RenderDevice::m_bDungeon != 3 && RenderDevice::m_bDungeon != 4)
            {
                ...
                RenderScaled(pMesh, m_vecPosition.x, m_fHeight, m_vecPosition.y, m_fAngle, 0, 0, 7, 0);
            }
            else
            {
                ...
                RenderScaled(pMesh, m_vecPosition.x, m_fHeight, m_vecPosition.y, m_fAngle, 0, 0, 4, 0);
            }
        ...
        else if (m_cHouseType == 4)
        {
            ...
            RenderScaled(pMesh1, m_vecPosition.x, m_fHeight + 0.44999999f, m_vecPosition.y, -m_fWindMillAngle, 0, 0, 0, 0);
            RenderScaled(pMesh1, m_vecPosition.x, m_fHeight + 2.7f, m_vecPosition.y, -m_fWindMillAngle, 0, 0, 0, 0);
            RenderScaled(pMesh2, m_vecPosition.x, m_fHeight + 2.0f, m_vecPosition.y, m_fWindMillAngle, 0, 0, 0, 0);
        }
        else if (m_cHouseType == 5)
        {
            ...
            RenderScaled(pMesh1, m_vecPosition.x + m_vecPos1.x, m_fHeight + 1.2f, m_vecPosition.y + m_vecPos1.y, m_fAngle - 1.5707964f, m_fWindMillAngle, 1.5707964f, 0, 0);
            RenderScaled(pMesh1, m_vecPosition.x + m_vecPos2.x, m_fHeight + 1.2f, m_vecPosition.y + m_vecPos2.y, m_fAngle - 1.5707964f, -m_fWindMillAngle, 1.5707964f, 0, 0);
            RenderScaled(pMesh2, m_vecPosition.x, m_fHeight, m_vecPosition.y, m_fAngle, 0, 0, 0, 0);
        }
        else if (m_cHouseType == 6)
        {
            ...
            RenderScaled(pMesh1, m_vecPosition.x, m_fHeight, m_vecPosition.y, m_fAngle, 0, 0, 6, 0);
        }
        else if (m_cHouseType == 7)
        {
            ...
            RenderScaled(pMesh1, m_vecPosition.x, m_fHeight, m_vecPosition.y, m_fAngle, 0, 0, 101, 0);
        }
        else if (m_cHouseType == 8)
        {
            ...
            RenderScaled(pMesh1, m_vecPosition.x, m_fHeight, m_vecPosition.y, m_fAngle, 0, 0, 100, 0);
        }
