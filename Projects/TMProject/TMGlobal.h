...
struct stTextureOverrideContext
{
    int active;
    int type;
    int index;
...
extern stTextureOverrideContext g_TexOverride;

struct stMeshPartHideOverrideContext
{
    int active;
    unsigned int hideMask;
};

extern stMeshPartHideOverrideContext g_MeshPartHideOverride;
...
extern char g_UIString[1000][64];
